...
#pragma prefast(pop)
...
#if defined(_NO_INTRINSICS_)
            VECTOR N = Vector::Saturate(v);
            N = Vector::Multiply(N, g_UByteMax);
            N = Vector::Round(N);
...
#else
            pDestination->x = ConvertFloatToHalf(Vector::GetX(v));
            pDestination->y = ConvertFloatToHalf(Vector::GetY(v));
#endif // !_F16C_INTRINSICS_
        }
...
#if defined(_NO_INTRINSICS_)
            VECTOR N = Vector::Clamp(v, g_NegativeOne.v, g_One.v);
            N = Vector::Multiply(N, g_ShortMax);
            N = Vector::Round(N);
...
#if defined(_NO_INTRINSICS_)
            VECTOR N = Vector::Clamp(v, g_ShortMin, g_ShortMax);
            N = Vector::Round(N);
...
#if defined(_NO_INTRINSICS_)
            VECTOR N = Vector::Saturate(v);
            N = Vector::MultiplyAdd(N, g_UShortMax, g_OneHalf.v);
            N = Vector::Truncate(N);
...
#if defined(_NO_INTRINSICS_)
            VECTOR N = Vector::Clamp(v, Vector::Zero(), g_UShortMax);
            N = Vector::Round(N);
...
#if defined(_NO_INTRINSICS_)
            VECTOR N = Vector::Clamp(v, g_ByteMin, g_ByteMax);
            N = Vector::Round(N);
...
#if defined(_NO_INTRINSICS_)
            VECTOR N = Vector::Saturate(v);
            N = Vector::MultiplyAdd(N, g_UByteMax, g_OneHalf.v);
            N = Vector::Truncate(N);
...
#if defined(_NO_INTRINSICS_)
            VECTOR N = Vector::Clamp(v, Vector::Zero(), g_UByteMax);
            N = Vector::Round(N);
        ...
        FORCE_INLINE void VEC_CALLCONV StoreXDecN4(XDECN4* pDestination, A_VECTOR v) noexcept
        {
            ...
            VECTOR N = Vector::Clamp(v, Min.v, g_One.v);
            N = Vector::Multiply(N, Scale.v);
            N = Vector::Round(N);
...
#if defined(_NO_INTRINSICS_)
            VECTOR N = Vector::Clamp(v, MinXDec4, MaxXDec4);
...
#if defined(_NO_INTRINSICS_)
            VECTOR N = Vector::MultiplyAdd(v, Scale, Bias);
            N = Vector::Clamp(N, g_Zero, C);
...
#if defined(_NO_INTRINSICS_)
            VECTOR N = Vector::Clamp(v, Vector::Zero(), MaxUDec4);
...
#if defined(_NO_INTRINSICS_)
            VECTOR N = Vector::Clamp(v, MinDec4, MaxDec4);
...
#pragma warning(pop)
        ...
        {
            StoreShortN2(this, Vector::Set(_x, _y, 0.0f, 0.0f));
        }
        ...
        {
            StoreShort2(this, Vector::Set(_x, _y, 0.0f, 0.0f));
        }
        ...
        {
            StoreUShortN2(this, Vector::Set(_x, _y, 0.0f, 0.0f));
        }
        ...
        {
            StoreUShort2(this, Vector::Set(_x, _y, 0.0f, 0.0f));
        }
        ...
        {
            StoreByteN2(this, Vector::Set(_x, _y, 0.0f, 0.0f));
        }
        ...
        {
            StoreByte2(this, Vector::Set(_x, _y, 0.0f, 0.0f));
        }
        ...
        {
            StoreUByteN2(this, Vector::Set(_x, _y, 0.0f, 0.0f));
        }
        ...
        {
            StoreUByte2(this, Vector::Set(_x, _y, 0.0f, 0.0f));
        }
        ...
        {
            StoreU565(this, Vector::Set(_x, _y, _z, 0.0f));
        }
        ...
        {
            StoreFloat3PK(this, Vector::Set(_x, _y, _z, 0.0f));
        }
        ...
        {
            StoreFloat3SE(this, Vector::Set(_x, _y, _z, 0.0f));
        }
        ...
        {
            StoreShortN4(this, Vector::Set(_x, _y, _z, _w));
        }
        ...
        {
            StoreShort4(this, Vector::Set(_x, _y, _z, _w));
        }
        ...
        {
            StoreUShortN4(this, Vector::Set(_x, _y, _z, _w));
        }
        ...
        {
            StoreUShort4(this, Vector::Set(_x, _y, _z, _w));
        }
        ...
        {
            StoreXDecN4(this, Vector::Set(_x, _y, _z, _w));
        }
...
#pragma GCC diagnostic ignored "-Wdeprecated-declarations"
        ...
        {
            StoreXDec4(this, Vector::Set(_x, _y, _z, _w));
        }
        ...
        {
            StoreDecN4(this, Vector::Set(_x, _y, _z, _w));
        }
        ...
        {
            StoreDec4(this, Vector::Set(_x, _y, _z, _w));
        }
...
#pragma warning(pop)
        ...
        {
            StoreUDecN4(this, Vector::Set(_x, _y, _z, _w));
        }
        ...
        {
            StoreUDec4(this, Vector::Set(_x, _y, _z, _w));
        }
        ...
        {
            StoreByteN4(this, Vector::Set(_x, _y, _z, _w));
        }
        ...
        {
            StoreByte4(this, Vector::Set(_x, _y, _z, _w));
        }
        ...
        {
            StoreUByteN4(this, Vector::Set(_x, _y, _z, _w));
        }
        ...
        {
            StoreUByte4(this, Vector::Set(_x, _y, _z, _w));
        }
        ...
        {
            StoreUNibble4(this, Vector::Set(_x, _y, _z, _w));
        }
